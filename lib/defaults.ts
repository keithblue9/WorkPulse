...
export const DEFAULT_WIDGETS = [
  ...
  { key:'budget-yield',       label:'Budget: Yield (Plan vs Realisasi)', segment:'main', active:true, order:1 },
  { key:'budget-realpct',     label:'Budget: % Realisasi per Cost Element', segment:'main', active:true, order:2 },
  { key:'budget-prognosa',    label:'Budget: Prognosa & Sisa', segment:'main', active:true, order:3 },
  { key:'budget-cashcard',    label:'Budget: Settlement Cash Card %', segment:'main', active:true, order:4 },
  { key:'team-availability',  label:'Team Availability (presensi)', segment:'main', active:true, order:5 },
  { key:'mandatory-mcu',      label:'Mandatory: MCU', segment:'main', active:true, order:6 },
  { key:'mandatory-training', label:'Mandatory: Training', segment:'main', active:true, order:7 },
  { key:'mandatory-kpi',      label:'Mandatory: Support KPI', segment:'main', active:true, order:8 },
  { key:'golive-insights',    label:'Go-Live per Aplikasi', segment:'main', active:true, order:9 },
  { key:'ai-row',             label:'AI Insights (baris)',  segment:'main', active:true, order:10 },
  { key:'progress-chart',     label:'Chart Progress (donut)', segment:'main', active:true, order:11 },
  { key:'upcoming-agenda',    label:'Agenda Mendatang',    segment:'main', active:true, order:12 },
