...
const MENU_KEYS = ['dashboard','progress','activities','calendar','issues','attendance','biodata','links','meetings','notes','quicknotes','playground','reimbursement','operasional','pettycash','cashcard','thirdparty','budgetreport','cashier','settlementcc','members','config','biodata-export']
const MENU_LABELS: Record<string,string> = {
  ...
  members:'Member', config:'Configuration', 'biodata-export':'Export Biodata (Excel) — admin'
}
